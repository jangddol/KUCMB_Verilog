...
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { scl }]; #IO_0_14 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports { sda }]; #IO_L6N_T0_D08_VREF_14   Sch=ck_io[1]
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { ck_io2 }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { cover_led[5] }]; #IO_L13P_T2_MRCC_14      Sch=ck_io[3]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { cover_led[6] }]; #IO_L13N_T2_MRCC_14      Sch=ck_io[4]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { cover_led[7] }]; #IO_L14P_T2_SRCC_14      Sch=ck_io[5]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { cover_led[8] }]; #IO_L14N_T2_SRCC_14      Sch=ck_io[6]
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { VCC2 }]; #IO_L16N_T2_A15_D31_14   Sch=ck_io[7]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { wb_in[3] }]; #IO_L17P_T2_A14_D30_14   Sch=ck_io[8]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { wb_in[2] }]; #IO_L17N_T2_A13_D29_14   Sch=ck_io[9]
...
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { wb_in[1] }]; #IO_L22P_T3_A17_15   Sch=ck_io10_ss
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { wb_in[0] }]; #IO_L22N_T3_A16_15   Sch=ck_io11_mosi
...
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { cover_led[0] }]; #IO_L23P_T3_A03_D19_14        Sch=jd8/ck_io[28]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { cover_led[1] }]; #IO_L22N_T3_A04_D20_14        Sch=jd7/ck_io[29]
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { cover_led[2] }]; #IO_L22P_T3_A05_D21_14        Sch=jd4/ck_io[30]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { cover_led[3] }]; #IO_L21N_T3_DQS_A06_D22_14    Sch=jd3/ck_io[31]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { cover_led[4] }]; #IO_L21P_T3_DQS_14            Sch=jd2/ck_io[32]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { VCC }]; #IO_L20N_T3_A07_D23_14        Sch=jd1/ck_io[33]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { wsw_in[3] }]; #IO_L20P_T3_A08_D24_14        Sch=jc10/ck_io[34]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { wsw_in[2] }]; #IO_L19N_T3_A09_D25_VREF_14   Sch=jc9/ck_io[35]
set_property -dict { PACKAGE_PIN P13   IOSTANDARD LVCMOS33 } [get_ports { wsw_in[1] }]; #IO_L19P_T3_A10_D26_14        Sch=jc8/ck_io[36]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { wsw_in[0] }]; #IO_L16P_T2_CSI_B_14          Sch=jc7/ck_io[37]
...
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { VCC }]; #IO_0_15            Sch=ck_a[0]
#set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { cover_led[4] }]; #IO_L4P_T0_15       Sch=ck_a[1]
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { cover_led[3] }]; #IO_L4N_T0_15       Sch=ck_a[2]
#set_property -dict { PACKAGE_PIN C13   IOSTANDARD LVCMOS33 } [get_ports { cover_led[2] }]; #IO_L6P_T0_15       Sch=ck_a[3]
#set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS33 } [get_ports { cover_led[1] }]; #IO_L6N_T0_VREF_15  Sch=ck_a[4]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { cover_led[0] }]; #IO_L11P_T1_SRCC_15 Sch=ck_a[5]
